function tribo_analysis_roughness_3(zsim)
    ...
    [tpos, final_surface_roughness, i_tot_all, t_all, contact_area] = ...
        AFM_scan_4(x_pos, y_pos, initial_surface_roughness, zsim.comp_nodes, ...
        number_of_intervals, relaxation_time_intervals, number_of_time_steps, actual_dt, ...
        'Diamond', 'Cr2O3', zsim.load, zsim.v_tip, zsim.eapp, zsim.ecorr, ...
        zsim.alpha, zsim.i0_field, zsim.Ef, zsim.i0, zsim.i0_Me, zsim.i0_mono, i0p2, ...
        zsim.cutoff_time, zsim.vact);
    %=====================================================================
